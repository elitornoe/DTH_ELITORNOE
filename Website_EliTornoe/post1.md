>❕**Note for Stephan** Inspired by the first prompt for Assignment 1.

# The Digital Technologies of English
You know the scene, a dark library, dusty tomes from floor to ceiling, beige trenchcoats and pretentious discussions about Shakespeare. <i>English</i> as an academic discipline is so well established you would think it had been bolted to the ground two hundred years ago, as if any modern change was only reluctantly incorporated under duress. I cannot dispute there may be the stray student who would prefer to write their dissertation on a typewriter, but you would be amiss to claim that an English university program is completely void of any virtual technology. 

For this blogpost I want to take my reader through how a degree in <i>English</i> can and do incorporate digital tools and technologies, using personal experience from my years at Aarhus University's Bachelor and Master program in Denmark.

Aarhus University has delineated their English degree program into three primary branches:<sup><a href=https://bachelor.au.dk/engelsk>[1]</a></sup>

1. Literature
2. Linguistics
3. History, Society and Culture

During the Bachelor program every student is required to take classes in all three subjects, giving each student a generalised base, but every student will eventually develop their own specialisation through electives and personal projects. It is difficult to map out universal digital technologies applicable to everyone with an English degree, but I will here try to talk generally about the three branches.

For my own approach, I tend to work within sociolinguistics, with a focus on queer and feminist approaches to examine contemporary discourses, and in particular gendered language. My methods tend to use close readings of online forums or news articles and analysing them in a sociocultural context. I therefore tend to use online spheres for data collection for primary sources.
...
The first, and perhaps most obvious, way English has been shaped by digital technologies is how access to research has been made increasingly available. Digitised databases, archives of primary sources, searchable PDFs, knowledge in all shapes and sizes are much more available to the modern student and professor, than prior to the internet.

Physical archives are still vital, and seeing artifacts in person can give a different familiarity with the material, but when it comes to manuscripts, newspapers or pictures for your average student, a digital scan or transcript will serve you perfectly fine.

The sheer amount of data out there does however create a new problem: vetting the quality and relevance of what you find. Furthermore, the upkeep of these digital databases is of course an ongoing and life-long project and we are still limited to what has actually been deemed important enough to keep.
...
So, what does the humanities look like in the digital era we find ourselves in? Firstly, the internet has had a democratising effect on access to knowledge and resources. There are countless online databases available for free use, 

Digital platforms and human behaviour on them have also become a field of study of their own, whether that is social literature - such as fanfiction and collaborative story worlds - or linguistic innovation. The internet is a honeypot of data, both in the classic content analysis way, as well as anthropologically. 

You can certainly still do *English* in the classical way, and in fact you should engange in close-reading and slow analysis if for nothing else, then to keep your brain sharp. But the field as an academic praxis is expanding and effectivising, keeping up with the times and utilise both approaches is necessary for the modern researcher. 
